  ...
  return (
    <div className="fixed top-0 right-4 z-50 md:hidden">
      ...
      <button
        ...
        className="m-1 h-fit w-fit rounded-sm bg-orange-300/80 p-2"
      ...
      >
        ...
        <div className="relative h-[24px] w-[24px]">
          ...
          />
          <span
            className={`absolute top-[10px] left-0 h-[3px] w-full bg-gray-900 transition-all duration-300 ${
      ...
      {isOpen && (
        <div
          className="fixed inset-0 z-0 mt-12 bg-black/30"
      ...
      <div
        ref={menuRef}
        className={`fixed right-0 mx-auto h-full w-72 bg-white/95 p-4 transition-transform duration-300 ${
